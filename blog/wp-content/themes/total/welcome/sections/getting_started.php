<div class="getting-started-top-wrap clearfix">
	...
	<div class="theme-image">
		<img src="<?php echo esc_url(get_template_directory_uri(). '/screenshot.jpg'); ?>" alt="<?php echo esc_html__('Total Plus Demo', 'total'); ?>">
	...
	<div class="recomended-plugin-wrap clearfix">
		<div class="recom-plugin-wrap">
			...
			<div class="plugin-title-install clearfix">
				...
				<span class="plugin-btn-wrapper">
					<a target="_blank" href="http://demo.hashthemes.com/total-plus/main/" class="button button-primary"><?php echo esc_html__('Preview', 'total'); ?></a>
				</span>
			</div>
		</div>
		...
		<div class="recom-plugin-wrap">
			...
			<div class="plugin-title-install clearfix">
				...
				<span class="plugin-btn-wrapper">
					<a target="_blank" href="http://demo.hashthemes.com/total-plus/creative-agency" class="button button-primary"><?php echo esc_html__('Preview', 'total'); ?></a>
				</span>
			</div>
		</div>
		...
		<div class="recom-plugin-wrap">
			...
			<div class="plugin-title-install clearfix">
				...
				<span class="plugin-btn-wrapper">
					<a target="_blank" href="http://demo.hashthemes.com/total-plus/one-page" class="button button-primary"><?php echo esc_html__('Preview', 'total'); ?></a>
				</span>
			</div>
		</div>
...
<div class="upgrade-box">
	<div class="upgrade-box-text">
		<h3><?php echo esc_html__('Upgrade To Premium Version', 'total'); ?></h3>
